...
In this challenege I used Python and SQLAlchemy to do a basic climate analysis and data exploration of my climate database. Specifically, I use SQLAlchemy ORM queries, Pandas, and Matplotlib. To do so, I completed the following steps:
...
Design a Flask API based on the queries that I just developed
